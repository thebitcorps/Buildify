class ConstructionsController < ApplicationController
  ...
  private
    ...
    def construction_params
      params.require(:construction).permit(:title, :start_date,:address, :status,:finish_date, :contract_amount, :user_id, construction_users_attributes: [:user_id,:role,:_destroy])
    end
