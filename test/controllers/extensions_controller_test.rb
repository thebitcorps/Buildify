...
class ExtensionsControllerTest < ActionController::TestCase
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post :create, extension: { amount: @extension.amount, construction_id: @extension.construction_id, date: @extension.date }
    end
  ...
  test "should update extension" do
    patch :update, id: @extension, extension: { amount: @extension.amount, construction_id: @extension.construction_id, date: @extension.date }
    assert_redirected_to extension_path(assigns(:extension))
  end
